...
export async function GET() {
  ...
  // HOTFIX:
  // Temporarily disable alerting while investigating Cloudflare
  // waitUntil() cancellation warnings. Health endpoints should not
  // perform non-essential side effects.
  //
  // try {
